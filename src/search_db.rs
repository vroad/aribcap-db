...
pub use query::{
    CaptionLine, CaptionPage, GenreFilter, IndexedRecord, ProgramDetails, SearchFilter, SearchHit,
    SearchProgram, find_indexed_record, get_caption_page, list_indexed_records, search_captions,
    search_combined, search_general, search_programs,
};
pub use text::{
